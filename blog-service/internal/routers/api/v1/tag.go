...
import (
	...
	"github.com/hoseazhai/gopl_learning/blog-service/internal/service"
	"github.com/hoseazhai/gopl_learning/blog-service/pkg/app"
	"github.com/hoseazhai/gopl_learning/blog-service/pkg/convert"
...
// @Summary 获取多个标签
// @Produce json
// @Param name query string false "标签名称" maxlenght(100)
// @Param state query  int false "状态"  Enum(0,1) default(1)
// @Param page query int false "页码"
// @Param page_size query int false "每页数量"
// @Success 200 {object} model.TagSwagger "成功"
// @Failure 400 {object} errcode.Error "请求错误"
// @Failure 300 {object} errcode.Error "内部错误"
...
func (t Tag) List(c *gin.Context) {
	...
	totailRows, err := svc.CountTag(&service.CountTagRequest{Name: param.Name, State: param.State})
	if err != nil {
	...
	response.ToResponseList(tags, totailRows)
...
func (t Tag) Create(c *gin.Context) {
	...
	//param.CreatedBy = c.PostForm("created_by")
	////("新增的标签的名称:%s", param.Name)
	//
	//log.Print(c.PostForm("name"))
	response := app.NewResponse(c)
	valid, errs := app.BindAndValid(c, &param)
	if !valid {
		global.Logger.Errorf(c, "app.BindAndValid errs:%v", errs)
